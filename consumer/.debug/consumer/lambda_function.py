...
def sqs_queue_resource(queue_name):
    ...
    {'ApproximateNumberOfMessages': '0',
     ...
     'QueueArn': 'arn:aws:sqs:us-east-1:414930948375:dev-job-24910',
...
def lambda_handler(event, context):
    ...
    #'eventSourceARN': 'arn:aws:sqs:us-east-1:107164737472:producer'
    ...
    # Write result to S3
    write_s3(df=df, bucket="consumer96", name=names)